...
Locals["SCALE_ZOOM_BY_SIZE"] = "Масштабувати зум за розміром ворога"
Locals["SCALE_ZOOM_BY_SIZE_DESC"] = "Динамічно відсуває камеру для більших ворогів (босів, велетнів). Камера ніколи не наблизиться ближче за вашу Бойову дистанцію. Коли великий ворог гине, камера підлаштовується до наступного найбільшого."

Locals["SIZE_ZOOM_MAX_YARDS"] = "Макс. дистанція за розміром"
Locals["SIZE_ZOOM_MAX_YARDS_DESC"] = "Максимальна дистанція камери для найбільших ворогів. Бойова дистанція є мінімальною межею."
