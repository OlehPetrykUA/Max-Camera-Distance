...
Database.DEFAULTS = {
    ...
    FORCE_COMBAT_IN_INSTANCE = true,
    AUTO_MOUNT_ZOOM = false,
    COMBAT_ZOOM_FACTOR = MAX_YARDS,
    SCALE_COMBAT_ZOOM_BY_SIZE = false,
    SIZE_ZOOM_MAX_YARDS = MAX_YARDS,
...
function Database:InitDB()
    ...
    local defaultProfile = {
        ...
        forceCombatInInstance = Database.DEFAULTS.FORCE_COMBAT_IN_INSTANCE,
        combatZoomFactor = Database.DEFAULTS.COMBAT_ZOOM_FACTOR,
        scaleCombatZoomBySize = Database.DEFAULTS.SCALE_COMBAT_ZOOM_BY_SIZE,
        sizeZoomMaxYards = Database.DEFAULTS.SIZE_ZOOM_MAX_YARDS,
